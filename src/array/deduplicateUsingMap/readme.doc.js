module.exports = (pkg, meta, types) => ({
  title: 'array.deduplicateUsingMap',
  sections: [
    {
      ...
      content: [
        {
          ...
          script: {
            ...
            content: `import deduplicateUsingMap from '${meta.npm.name}/array/deduplicateUsingMap';`,
          },
        },
      ],
    },
    ...
    },
    {
      ...
      title: 'deduplicateUsingMap(array[, getId = v => v])',
      content: [
        {
